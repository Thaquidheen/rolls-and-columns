...
export function PowerBIHeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <Image
          src="/images/powerbi/image 118 (1).png"
          alt="MS Power Platform Background"
          fill
        ...
        <div className="h-full flex items-center">
          <div className="w-full max-w-4xl">
            <div className="space-y-6">
              ...
              >
                <span className="word inline-block text-white">MS </span>
                <span className="word inline-block text-white">POWER</span>
                <br />
                <span className="word inline-block text-white">PLATFORM</span>
              </h1>
