...
export function SapHeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <Image
          src="/images/sap/image 118.png"
          alt="SAP ERP Integration Background"
          fill
        ...
        <div className="h-full flex items-center">
          <div className="w-full max-w-4xl">
            <div className="space-y-6">
              ...
              >
                <span className="word inline-block text-white">SAP</span>{" "}
                <span className="word inline-block text-white">ERP</span>{" "}
                <span className="word inline-block text-white">INTEGRATION</span>
                <br />
                <span className="word inline-block text-white">WITH</span>{" "}
                <span className="word inline-block text-white">POWER</span>{" "}
                <span className="word inline-block text-white">BI</span>
              </h1>
