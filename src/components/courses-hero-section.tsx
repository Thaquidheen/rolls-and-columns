  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <Image
          src="/images/courses/image 118.png"
        ...
        <div className="h-full flex items-center">
          <div className="w-full max-w-4xl">
            <div className="space-y-6 sm:space-y-8">
              ...
              >
                <span className="word inline-block text-white">AVAILABLE</span>
                <br />
                <span className="word inline-block text-white">COURSES</span>
              </h1>
